...
int main()
{
	...
	string data_indonesia = getJSON("https://api.kawalcorona.com/indonesia");
...
//	cout << "JSON Data: \n" << data_tanggal << endl;
	...
	cout << "TOTAL DATA COVID 19 DI INDONESIA s/d HARI INI" << endl;
	cout << "Negara		= " << obj["name"].asString() << endl;
	cout << "Positif		= " << obj["positif"].asString() << endl;
	cout << "Sembuh		= " << obj["sembuh"].asString() << endl;
	cout << "Meninggal	= " << obj["meninggal"].asString() << endl;
